...
<div class="container p-0 m-0">
    ...
    <div class="row container pl-0 m-0 mb-2 align-content-end justify-content-end">
    ...
    <div class="received-message d-flex border-danger d-flex align-items-center pt-1 pb-1" data-id="{{$email->id}}" data-href="{{'/mail/'.$email->id}}" role="link">
            <div class="container receivedWrapper ">
                <div class="inbox-1 border-info">
                    <div class="inbox-wrapper">
                        <div class="left-control">
                            <label class="check-container">
                                <input type="checkbox" name="mail_id" id="{{$email->id}}" class="checkbox" />
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="mail-message grid-width-80">
                            {{$email->heading}}
                        </div>
